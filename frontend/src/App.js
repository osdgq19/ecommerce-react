    ...
    <BrowserRouter>
      <div className="grid-container">
            ...
            {userInfo && userInfo.isAdmin === 'true' ? (
              <div className="dropdown">
                ...
                <ul className="dropdown-content">
                  ...
                  <li>
                    <Link to="/reportdecisionoption">
                      Reportes de toma de decision
                    </Link>
                  </li>
                  <li>
        ...
        <main>
          ...
          <Route
            path="/reportdecisionoption"
            component={ReportDecisionOption}
          ></Route>
          <Route
            path="/reportsdecision"
            component={ReportDecisionScreen}
          ></Route>
