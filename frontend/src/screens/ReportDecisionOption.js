  ...
  return (
    <div>
      <ul onClick={ReportHandler}>
        <li>
          <a id="Ganancias">Reporte de ganancias</a>
        </li>
        <li>
          <a id="Entregas">Reporte de entregas</a>
        </li>
        <li>
          <a id="Ordenes">Reporte de ordenes registradas</a>
        </li>
        <li>
          <a id="Cobradas">Reporte de ordenes cobradas</a>
        </li>
        <li>
          <a id="Producto">Reporte de producto mas vendido</a>
        </li>
      </ul>
    </div>
  )
