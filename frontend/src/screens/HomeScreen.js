        ...
        loading ? (<LoadingBox></LoadingBox>) :
          ...
          error ? (<MessageBox variant="danger">{error}</MessageBox>) :
            ...
            (<div className="row center">
              {
                products.filter(val => {
                   if(props.buscar === "" && (props.filtro ==="Todas" || props.filtro ===" ")) {return val}
                   else if(
                    
                     val.name.toLowerCase().includes(props.buscar.toLowerCase()) && val.nombre_categoria.toLowerCase().includes(props.filtro.toLowerCase())) {
                    return val
