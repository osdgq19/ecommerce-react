      ...
      <div className="col-2">
        ...
        {mineProds?.length === 0 ? (
          <MessageBox>
            ...
            <Link to="/addproduct">Ofrecer un producto</Link>
          </MessageBox>
        ) : (
          <ul>
            {mineProds?.map(item => (
              <li key={item.product}>
                ...
                <div className="row">
                  ...
                  <div>Precio de venta: ${item.price}</div>

                  <div>
                    <button
                      type="button"
                      onClick={() => removeMyProductHandler(item.product)}
                    >
                      Delete
                    </button>
                  </div>
                  ...
                  <div>
                    <button
                      type="button"
                      onClick={() => updateMyProductHandler(item.product)}
                    >
                      Modificar
                    </button>
                  </div>
