...
export default function PlaceOrderScreen(props) {
  ...
  cart.shippingPrice = estados?.find(
    x => x.idstate === Number(cart.shippingAddress.estado),
  )
  console.log(cart.shippingPrice)
  cart.taxPrice =
    cart.impuesto === 'Exento'
      ? toPrice(cart.itemsPrice)
      : toPrice(0.16 * cart.itemsPrice)
            ...
            <li>
              <div className="card card-body">
                ...
                <p>
                  ...
                  , {cart?.shippingPrice.state_name} , {'Venezuela'}
                </p>
              </div>
            </li>
            {console.log(cart)}
            <li>
              <div className="card card-body">
                ...
                <p>
                  ...
                  {cart?.paymentMethod[0]?.name} <br></br>
                </p>
              </div>
            </li>
