    ...
    return (
        <div>
            <ul onClick={ReportHandler} >
                <li><a id='Categoria'>Reporte de categoria</a></li>
                <li><a id='Marca'>Reporte por marca</a></li>
                <li><a id="Precio">Reporte por precio</a></li>
                <li><a id="Cantidad">Reporte por cantidad</a></li>
            </ul>
        </div>
    )
}
