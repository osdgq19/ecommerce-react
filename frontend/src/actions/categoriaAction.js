...
import { CATEGORIA_REQUEST,CATEGORIA_SUCCESS,CATEGORIA_FAIL, CATEGORIA_ADD_REQUEST, CATEGORIA_ADD_SUCCESS, CATEGORIA_ADD_FAIL, CATEGORIA_DELETE} from "../constants/categoriaConstants"
    ...
    dispatch({ type: CATEGORIA_ADD_REQUEST })
      try {console.log(datos)
          ...
          dispatch({
            ...
            type: CATEGORIA_ADD_SUCCESS, payload: data.status
