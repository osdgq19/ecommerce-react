...
const initialState = {
  ...
  myProds: {
    mineProds: localStorage.getItem('mineProds')
      ? JSON.parse(localStorage.getItem('mineProds'))
      : [],
  },

  estados: {
    mineProds: localStorage.getItem('estados')
